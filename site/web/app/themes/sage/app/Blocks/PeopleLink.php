...
class PeopleLink extends Block
{
    /**
     * The block name.
     *
    ...
    {
        $people = new FieldsBuilder('people-link');

        $people
            ->addButtonGroup('people_link_content_type', [
            ...
            ->addImage('people_link_image', [
                ...
                ->conditional('people_link_content_type', '==', 'img')
            ->addText('people_link_video_zone', [
                ...
                ->conditional('people_link_content_type', '==', 'video')
            ->addText('people_link_video_id', [
                'label' => __('Video ID', 'sage'),
                'default_value' => '6ea813d4-bd21-439f-8d1a-02f0645a51fa',
            ])
                ->conditional('people_link_content_type', '==', 'video')
            ->addText('people_link_video_poster', [
                ...
                ->conditional('people_link_content_type', '==', 'video')
            ->addText('people_link_short_name', [
                'label' => __('Person short name', 'sage'),
                'required' => 1,
            ])
            ->addText('people_link_hover_text', [
                'label' => __('Hover text', 'sage'),
            ])
            ->addText('people_link_text', [
                'label' => __('Text', 'sage'),
            ])
            ->addUrl('people_link_link', [
                'label' => __('Link', 'sage'),
                'instructions' => __('Click destination', 'sage'),
                'return_format' => 'array',
            ]);
    ...
    {
        $person = [
            'people_link_content_type' => get_field('people_link_content_type'),
            'people_link_image' => get_field('people_link_image'),
            'people_link_short_name' => get_field('people_link_short_name'),
            'people_link_name' => get_field('people_link_name'),
            'people_link_video_zone' => get_field('people_link_video_zone'),
            'people_link_video_id' => get_field('people_link_video_id'),
            'people_link_video_poster' => get_field('people_link_video_poster'),
            'people_link_text' => get_field('people_link_text'),
            'people_link_hover_text' => get_field('people_link_hover_text'),
            'people_link_link' => get_field('people_link_link'),
        ];

        if (!empty($person['people_link_image'])) {
            $person['people_link_image_src'] = wp_get_attachment_image_src($person['people_link_image']['id'], 'large');
        };
