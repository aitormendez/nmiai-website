...
<div id="tagline" class="text-dark dark:text-light fixed top-3 z-40 hidden font-serif font-bold md:block">
  {{ get_bloginfo('description') }}
</div>

<button id="btnDot" class="bg-light fixed top-4 z-40 h-4 w-4 rounded-full mix-blend-exclusion"></button>
