    ...
    <div class="bottom my-6 flex flex-wrap items-center justify-between md:justify-start">
      ...
      <div class="progress relative mb-4 flex w-full items-center justify-between">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
          <circle id="Elipse_2596" data-name="Elipse 2596" cx="8" cy="8" r="8" class="fill-dark dark:fill-white" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
      ...
      <div class="labels flex w-full justify-between">
        <span class="dark:text-white start-text order-1 mr-4 font-serif font-bold md:order-none">{{ $section['start_text'] }}</span>
