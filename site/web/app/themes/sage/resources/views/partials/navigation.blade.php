@if ($navigation)
  <div id="main-menu"
    class="my-menu bg-dark fixed left-0 top-0 z-40 flex h-screen w-screen items-center justify-center text-4xl text-white md:text-7xl lg:text-8xl xl:text-9xl"
