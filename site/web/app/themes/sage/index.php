...
<html <?php language_attributes(); ?> class="scroll-smooth">
  ...
  <div id="main-flap" class="bg-dark fixed w-screen h-screen opacity-0 transition-opacity duration-500 z-[60] hidden flex-col items-center px-12 md:px-[20vw] text-white text-center">
